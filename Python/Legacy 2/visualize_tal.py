...
#Based on https://bioimagesuiteweb.github.io/webapp/mni2tal.html
...
def plot_coordinates(xyz, input_coordinate = None, colored = None, save_path = None):
    ...
    D2_img = plt.imread(fname=cwd+'\\Talairach\\'+img_path)
...
# xyz = np.array([51.,  -72.7,  -14.])
# print(xyz)
# plot_coordinates(xyz,input_coordinate = 'tal', colored = True)
